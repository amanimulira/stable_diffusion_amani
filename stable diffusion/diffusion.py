...
class UNET_ResidualBlock(nn.Module):
    ...
    def __init__(self, in_channels: int, out_channels, n_time=1280):
        super().__init__()

        self.groupnorm_feature = nn.GroupNorm(32, in_channels)
        self.conv_feature = nn.Conv2d(in_channels, kernel_size=3, padding=1)
    ...
    def forward(self, feature, time):
        # feature: (Batch_Size, In_Channels, Heights, Width)
        # time (1, 1280)
...
class Upsample(nn.Module):
    ...
    def forward(self, x):
        # (Batch_Size, Features, Height, Width) -> (Batch_Size, Features, Height * 2, Wdith * 2)
